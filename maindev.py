...
def main():
    ...
    <div style="font-size: 12px; text-align: left; column-count: 2; column-gap: 40px; margin-top: 20px;">
        <ol style="list-style: decimal inside;">
            <li>OP 公益服务列表详见 <a href="https://api.op414.com/" target="_blank" rel="noopener noreferrer">https://api.op414.com/</a>，本站为测试服，支持高并发，模型可用性由高到低，限制文件上传大小10mb</li>
    ...
    # 定义标题HTML，包含标题和小字内容
    title_html = f"""
    <h1 style="text-align: center;">OP GPT Academic 公益测试服 {get_current_version()}</h1>
    {theme_declaration}
    {small_text_html}
    """
